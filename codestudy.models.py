...
class CtdUser(models.Model):
    user_id = models.CharField(db_column='USER_ID', primary_key=True, max_length=40)  # Field name made lowercase.
    user_email = models.CharField(db_column='USER_EMAIL', max_length=40, blank=True, null=True)  # Field name made lowercase.
    user_name = models.CharField(db_column='USER_NAME', max_length=80)  # Field name made lowercase.
    user_password = models.CharField(db_column='USER_PASSWORD', max_length=40)  # Field name made lowercase.
    user_phone = models.CharField(db_column='USER_PHONE', max_length=15, blank=True, null=True)  # Field name made lowercase.
    ...
    data_state = models.IntegerField(db_column='DATA_STATE', blank=True, null=True)  # Field name made lowercase.
